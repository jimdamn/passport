...
// Field Notes (HTTP, best-effort) plus Fresh Today and Sale Day (local D1)
// for the Passport profile's "My Posts" cards. Each leg is best-effort; a
// down or slow source degrades to an empty summary rather than failing the
// whole request.
